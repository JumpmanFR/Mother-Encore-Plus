...
const REMAPPABLE_ACTIONS = [["ui_up", "ui_down", "ui_left", "ui_right", "ui_accept", "ui_cancel", "ui_toggle", "ui_scope", "ui_focus_prev", "ui_focus_next", "ui_select", "ui_plate", "ui_map", "ui_fullscreen", "ui_winsize"], ["ui_up", "ui_down", "ui_left", "ui_right", "ui_accept", "ui_cancel", "ui_toggle", "ui_scope", "ui_focus_prev", "ui_focus_next", "ui_select", "ui_plate", "ui_map"]]
